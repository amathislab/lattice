...
parser.add_argument('--alpha', type=float, default=1.0,
                    help='Weight of the uncorrelated noise (only for lattice)')
...
TENSORBOARD_LOG = (
    ...
    + f"_elbow_pose_sde_{args.use_sde}_lattice_{args.use_lattice}_freq_{args.freq}_log_std_init_{args.log_std_init}_std_reg_{args.std_reg}_alpha_{args.alpha}_recurrent_ppo_seed_{args.seed}_resume_{model_name}"
)
