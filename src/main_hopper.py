...
TENSORBOARD_LOG = (
    ...
    + f"_hopper_sde_{args.use_sde}_lattice_{args.use_lattice}_freq_{args.freq}_log_std_init_{args.log_std_init}_std_reg_{args.std_reg}_sac_seed_{args.seed}_resume_{model_name}_target_entropy_{target_entropy}_std_clip_{std_clip}_gelu"
)
